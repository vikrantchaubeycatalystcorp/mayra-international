...
export function ExamCard({ exam }: { exam: MockExam }) {
  ...
  return (
    <Link href={`/mock-tests/${exam.slug}`}>
      <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-primary-100/50 hover:-translate-y-1 hover:border-primary-200">
        {/* Gradient accent */}
        ...
        <h3 className="mt-4 text-lg font-bold text-gray-900 group-hover:text-primary-700 transition-colors line-clamp-1">
          {exam.name}
        </h3>
        ...
        <div className="mt-4 flex items-center justify-between border-t border-gray-100 pt-4">
          ...
          <div className="flex items-center gap-1 text-sm font-semibold text-primary-600 opacity-0 group-hover:opacity-100 transition-opacity">
