...
const confidenceOptions: { level: ConfidenceLevel; label: string; icon: React.ElementType; color: string; bg: string }[] = [
  ...
  { level: "maybe", label: "Maybe", icon: CircleDot, color: "text-accent-600", bg: "bg-accent-50 border-accent-200 hover:bg-accent-100" },
            ...
            <div className="mb-6 flex items-start justify-between">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <span className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-primary-100 text-sm font-bold text-primary-700">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium transition-all ${
                  currentAnswer?.isMarked
                    ...
                    : "bg-gray-100 text-gray-500 hover:bg-accent-50 hover:text-accent-600"
                }`}
              >
                  ...
                  <button
                    ...
                    className={`group w-full flex items-center gap-4 rounded-2xl border-2 p-4 sm:p-5 text-left transition-all duration-200 ${
                      isSelected
                        ...
                        : "border-gray-200 bg-white hover:border-primary-200 hover:bg-primary-50/30 hover:shadow-sm"
                    }`}
                  >
                    <span
                    ...
                    <span className={`flex-1 text-sm sm:text-base ${isSelected ? "text-primary-900 font-medium" : "text-gray-700"}`}>
                      {option.text}
                    </span>
                    {isSelected && (
                      <CheckCircle2 className="ml-auto h-5 w-5 text-primary-600 shrink-0" />
                    )}
                    {/* Keyboard hint */}
          ...
          <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
            ...
            <div className="mb-6 rounded-2xl bg-gray-50 p-4 space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold text-accent-600">{markedCount}</span>
              </div>
              <div className="flex justify-between text-sm">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200"
              />
            </div>
